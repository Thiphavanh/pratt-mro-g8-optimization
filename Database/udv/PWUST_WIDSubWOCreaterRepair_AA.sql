...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_8DBF471E8D738C15E05387971F0A0130.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_8DBF471E8D738C15E05387971F0A0130';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_WIDSubWOCreaterRepair_AA';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='SMRO_WOE_304';
...
p1 clob :='object TCBScrollBox
  ...
  object SubWOCreatePreWI: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWUST_WOSubWoCreaterRepairPre''
