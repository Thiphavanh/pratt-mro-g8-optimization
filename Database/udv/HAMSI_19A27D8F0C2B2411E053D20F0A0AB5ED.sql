...
v_udv_id varchar2(85) :='HAMSI_19A27D8F0C2B2411E053D20F0A0AB5ED';
v_udv_tag varchar2(40) :='HAMSI_OrderSecGrpPermissionTabUdv';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='Order Sec Grp Permission Tab Udv';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object _OBJ3: TsfCommandButton
    ...
    OtherCommands.Strings = (      
        ''Desc=Set Permission,Priv={},Visible={},TagValue=,FKey=,Action=Invoke,Tool=PaarOrderSecGrpPermissionApproval,ReportToolId=,Params'' +
        ''(''POUND39_HOLDER''REQUEST_ID = :REQUEST_ID,''POUND39_HOLDER'',''POUND39_HOLDER''@InvokeToolMode=EDITMODES.Edit,''POUND39_HOLDER'',@InvokeTab=New)'')
  end
  object PAAROrderSecGrpPermissionSource: TSfSqlSource
    SelectOnUserConnection = False
    SelectSqlId = ''HAMSI_ORDERSECGRPPERMISSIONSTAB''
    ...
    PublishedSQLSourceName = ''PAAROrderSecGrpPermissionSource''
  end
end';
v_iclob clob;
begin
