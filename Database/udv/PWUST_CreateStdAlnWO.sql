...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_9457EABEBB98FD8BE05387971F0AED70.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_9457EABEBB98FD8BE05387971F0AED70';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_CreateStdAlnWO';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 1373';
...
p1 clob :='object TCBScrollBox
  ...
  object _OBJ2: TsfDBInputEdit
    ...
    Caption = 
      ''@Lookup(ITEM_TYPE,''#39''PART:Part No,TOOL:Tool No,PROCEDURE:Procedure'' +
      '' No,MACHINE:Machine No''#39'',''#39''Item No''#39'')''
    CaptionPos = cpLeft
  ...
  object _OBJ14: TsfDBInputEdit
    ...
    EntryType = etAlphaNumeric
    Caption = 
      ''@Lookup(ITEM_TYPE,''#39''PART:Part Rev,TOOL:Tool Rev,PROCEDURE:Procedu'' +
      ''re Rev,MACHINE:Machine Rev''#39'',''#39''Item Rev''#39'')''
    CaptionPos = cpLeft
    CaptionFont.Charset = DEFAULT_CHARSET
    CaptionFont.Color = clBlack
    CaptionFont.Height = -11
  ...
  object ItemSubtype: TsfDBInputEdit
    ...
    EntryType = etAlphaNumeric
    Caption = 
      ''@Lookup(ITEM_TYPE,''#39''PART:Part Subtype,TOOL:Tool Subtype,PROCEDURE'' +
      '':Procedure Subtype,MACHINE:Machine Subtype''#39'',''#39''Item Subtype''#39'')''
    CaptionPos = cpLeft
    CaptionFont.Charset = DEFAULT_CHARSET
    CaptionFont.Color = clBlack
    CaptionFont.Height = -11
  ...
  object _OBJ57: tSFInputListGrid
    Left = 95
    Top = 200
    Width = 150
    Height = 65
  ...
  object Order_uom: TsfDBInputEdit
    Left = 382
    Top = 410
    Width = 150
    Height = 23
  ...
  object SchedulePriority: TsfDBInputEdit
    Left = 95
    Top = 440
    Width = 150
    Height = 23
  ...
  object MainWorkLoc: TsfDBInputEdit
    Left = 382
    Top = 440
    Width = 150
    Height = 23
  ...
  object WorkLocation: TsfDBInputEdit
    Left = 79
    Top = 539
    Width = 95
    Height = 23
  ...
  object WorkDepartment: TsfDBInputEdit
    Left = 269
    Top = 539
    Width = 95
    Height = 23
    ...
    Font.Style = []
 ';
p2 clob :='ParentFont = True
    ShowHint = False
    TabOrder = 42
    EntryType = etAlphaNumeric
    Caption = ''Work Department''
    CaptionPos = cpLeft
    CaptionFont.Charset = DEFAULT_CHARSET
    CaptionFont.Color = clWindowText
    CaptionFont.Height = -11
  ...
  object WorkCenter: TsfDBInputEdit
    Left = 436
    Top = 539
    Width = 95
    Height = 23
  ...
  object OrderCreateStdAln: TSfSqlTransaction
    InputFieldsSSL.Strings = (
      ''ORDER_QTY''
      '' Update=False''
      '' Insert=RELATED_ORDER_ID <> ''#39#39'' OR DISC_ID <>''#39#39
      '' PopulateForInsert=Y''
      '' CharCase=Y''
      '' Hidden=False''
      '' Required=True''
      ...
      ''ORDER_TYPE''
      '' Update=False''
      '' Insert=DISC_ID<>''#39#39'' OR CHANGE_CALLED_FROM=''#39''No Plan''#39
      '' PopulateForInsert=Y''
      '' CharCase=N''
      '' Hidden=False''
      '' Required=False''
      '' PersistManualValues=Y''
      '' DependentFields=ORDER_NO,STARTING_ITEM_NO,STARTING_ITEM_CHG''
      ''PART_CHG''
      '' Update=True''
      '' Insert=True''
      '' PopulateForInsert=Y''
      ...
      '' Update=False''
        ...
        '' Insert=RELATED_ORDER_ID <> ''#39#39'' OR DISC_ID <>''#39#39'' OR CHANGE_CALLED_'' +
        ''FROM<>''#39''No Plan''#39
      '' PopulateForInsert=Y''
      '' CharCase=Y''
      '' Hidden=False''
      ...
      '' PersistManualValues=Y''
        ...
        '' Hidden=INSTRUCTIONS_TYPE=''#39''MRO-Part''#39'' OR INSTRUCTIONS_TYPE=''#39''MRO-U'' +
        ''pgrade''#39
      '' Required=False''
      ''WORK_FLOW''
      '' Update=False''
      '' Insert=CHANGE_CALLED_FROM=''#39''No Plan''#39
      '' PopulateForInsert=Y''
      '' CharCase=N''
      '' PersistManualValues=Y''
      '' Hidden=False''
      ...
      '' CharCase=N''
      '' PersistManualValues=Y''
      '' Hidden=INSTRUCTIONS_TYPE <> ''#39''MRO-Upgrade''#39
      '' Required=INSTRUCTIONS_TYPE = ''#39''MRO-Upgrade''#39
      ''CONFIG_NAME''
      '' Update=False''
      '' Insert=False''
      '' PopulateForInsert=N''
      ...
      '' Required=False''
      ''STOCK_UOM''
      '' Update=DISC_ID <>''#39#39
      '' Insert=DISC_ID <>''#39#39
      '' PopulateForInsert=Y''
      '' CharCase=N''
      '' PersistManualValues=Y''
      '' Required=True''
...
p3 clob :='''  VisibleFields''
      ...
      ''WO_LOT_NO''
      '' CtrlType=Lookup''
      ''  SqlId=MFI_LotNoLookUp''
      ''  ParamsSrc=DummyStartingPart,@UDVUserFieldValues''
      ''  Validate=N''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
      ''  IMLookupFilter=N''
      ...
      ''STARTING_ITEM_NO''
      '' CtrlType=Lookup''
      ''  SqlId=MFI_WID_STARTINGITEMLKUPFORUNPLANORDER''
      ...
      ''STARTING_ITEM_CHG''
      '' CtrlType=Lookup''
      ''  SqlId=MFI_WID_STARINGITEMREVLKUPFORUNPLANORDER''
      ''  ParamsSrc=@AuxParams,@UDVUserFieldValues''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
      ...
      ''  ParamsSrc=@UDVUserFieldValues, @ToolScope,@AuxParams''
      ''  Validate=Y''
      ''  DefaultToSingle=N''
      ''  ForceLookup=Y''
      ''  IMLookupFilter=N''
      ...
      '' CtrlType=Lookup''
      ''  Currency=N''
      ''  SqlId=MFI_WID_SERIALNUMBERMASKLKUP''
      ''  ParamsSrc=DummyStartingPart,@UDVUserFieldValues''
      ''  Validate=N''
      ''  DefaultToSingle=N''
      ''  ForceLookup=N''
    ...
    LinkedControls.Strings = (
      ...
      ''Order_uom~STOCK_UOM''
      ''_OBJ56~STARTING_ITEM_CHG''
      ''_OBJ58~PWP_ID''
      ''_OBJ59~CHANGE_REQUEST_ID''
      ''_OBJ60~PLANNED_ACTION_ID''
      ''_OBJ55~STARTING_ITEM_NO''
      ''_OBJ61~UNIT_TYPE''
      ''_OBJ62~UNIT_NO''
      ''MainWorkLoc~PLND_WORK_LOC''
      ''SchedulePriority~SCHED_PRIORITY''
      ''WorkLocation~ASGND_WORK_LOC''
      ''WorkDepartment~ASGND_WORK_DEPT''
      ''WorkCenter~ASGND_WORK_CENTER'')
  ...
  object DummyStartingPart: TSfSqlSource
    SelectOnUserConnection = False
    SelectSqlId = ''MFI_DummyStartingPartNo''
    PublishParams = True
    SelectedFields.Strings = (
      
        ''STARTING_ITEM_NO~0~STARTING_ITEM_NO~N~N~False~False~False~N~~~~~'' +
        ''Default~N~''
      
        ''STARTING_ITEM_CHG~0~STARTING_ITEM_CHG~N~N~False~False~False~N~~~'' +
        ''~~Default~N~'')
