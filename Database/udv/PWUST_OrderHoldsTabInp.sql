...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_66DA74FA1B5D94EAE05387971F0A9F96.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_66DA74FA1B5D94EAE05387971F0A9F96';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_OrderHoldsTabInp';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 376';
...
p2 clob :='_DATE''
    ...
    ParamsSQLSourceName = ''@AuxParams,OrderHoldTabSelect''
    RefreshParams = False
