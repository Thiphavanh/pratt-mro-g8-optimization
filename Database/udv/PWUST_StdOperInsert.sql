...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_6765D420600BEA7FE05387971F0A9537.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_6765D420600BEA7FE05387971F0A9537';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_StdOperInsert';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 50.';
...
p1 clob :='object TCBScrollBox
  ...
  Height = 300
  AutoScroll = False
  Caption = '':@TransactionType Standard Operation''
  ...
  object StdOperType: TsfDBInputEdit
    Left = 130
    Top = 20
    Width = 280
    Height = 25
  ...
  object StdOperCreate: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWUST_FND_StdOperCreate''
    UpdateSqlId = ''MFI_FND_StdOperUpdate''
    ParamsSQLSourceName = 
      ''@ToolScope,ReleasePackageStdOper,@AuxParams,PWUST_SEL_USER_WORK_'' +
      ''LOC''
    RefreshParams = False
