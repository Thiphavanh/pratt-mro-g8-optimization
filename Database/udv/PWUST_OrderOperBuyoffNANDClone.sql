...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUSD_9FF7D3EFCB759687E05387971F0A4021.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUSD_9FF7D3EFCB759687E05387971F0A4021';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_OrderOperBuyoffNANDClone';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect 1462lDefect1696; defect 1793';
...
p2 clob :='      '' CharCase=N''
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      '' CtrlType=Lookup''
      ''  Currency=N''
      ''  SqlId=PWUSD_GetAvailableUnitsforAddSignature''
      ''  ParamsSrc=@ScriptParams''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
    ...
    UpdateSqlId = ''dummy''
    ParamsSQLSourceName = ''@ScriptParams,BuyoffPercentComplete,SerialParams''
    RefreshParams = False
  ...
  object SerialParams: TsfTransactionParamSource
    SelectSqlId = ''PWUSD_GetAvailableUnitsforAddSignature''
    ParamsSQLSourceName = ''@ScriptParams''
    PublishParams = True
  end
end';
