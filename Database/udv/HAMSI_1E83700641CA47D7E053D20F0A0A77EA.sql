...
v_udv_id varchar2(85) :='HAMSI_1E83700641CA47D7E053D20F0A0A77EA';
v_udv_tag varchar2(40) :='HAMSI_ApprovalPermRemoveLocProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for Location Profile in Approval Permission Remove Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  Height = 300
  AutoScroll = False
  Caption = ''Permit or Deny Removal of Work Location''
