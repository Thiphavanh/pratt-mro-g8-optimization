...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_6821A50025445D78E05387971F0AFE0D.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_6821A50025445D78E05387971F0AFE0D';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_AdminWorkCenterUpd';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='SRMO_WOE_202';
...
p1 clob :='object TCBScrollBox
  ...
  object AdminWorkCenterUpd: TsfSqlTransaction
