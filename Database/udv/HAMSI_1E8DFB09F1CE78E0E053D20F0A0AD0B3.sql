...
v_udv_id varchar2(85) :='HAMSI_1E8DFB09F1CE78E0E053D20F0A0AD0B3';
v_udv_tag varchar2(40) :='HAMSI_PaarAppPermOrderSecGrpRmvlPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='PAAR Order Permission Approval Security Group Removal Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object OrderSecGrpProfileRemove: TSfSqlSource
    SelectOnUserConnection = False
    SelectSqlId = ''HAMSI_ApprovalPermissionOrderSecGrpDelProfileSel''
    ...
    InputUDVId = ''HAMSI_1E8DFB09F1D878E0E053D20F0A0AD0B3''
    InsUpdDelUDVId = ''HAMSI_1E8DFB09F1D878E0E053D20F0A0AD0B3''
    ...
    PublishedSQLSourceName = ''OrderSecGrpProfileRemove''
  end
end';
v_iclob clob;
begin
