...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_4B4038A537824FDEA4F2A178E8CD83A1.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_4B4038A537824FDEA4F2A178E8CD83A1';
v_udv_tag sfcore_udv_lib.udv_tag%type :='AuthorityInpMtx';
...
p1 clob :='object TCBScrollBox
  ...
  BottomMargin = -1
  object AuthorityInsUpd: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      '' CtrlType=List''
      ''  Values=Y~N'')
    InsertSqlId = ''PWMROI_AUTHORITY_TYPE_INSERT''
    UpdateSqlId = ''PWMROI_AUTHORITY_TYPE_UPDATE''
