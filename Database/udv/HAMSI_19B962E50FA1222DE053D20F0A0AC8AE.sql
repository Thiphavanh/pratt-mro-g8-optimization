...
v_udv_id varchar2(85) :='HAMSI_19B962E50FA1222DE053D20F0A0AC8AE';
v_udv_tag varchar2(40) :='HAMSI_WID_SuggestedPermissionLocPrfileIM';
...
p1 clob :='object TCBScrollBox
  ...
  object LocationProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_WID_LOCATIONPROFILEIMLOCATIONLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
