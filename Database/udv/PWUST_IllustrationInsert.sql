...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_C24BF06558500214E05387971F0A1AB4.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_C24BF06558500214E05387971F0A1AB4';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_IllustrationInsert';
...
p1 clob :='object TCBScrollBox
  ...
  Caption = ''@CONVERTLANGUAGE(@TransactionType) + ''#39'' Illustration''#39
  ...
  object StdTextInsert: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''    DelimitedBy=,''
      ''    SearchType=stAnyWords'')
    InsertSqlId = ''PWUST_IllustrationsIns''
    UpdateSqlId = ''MFI_FND_IllustrationUpd''
    ParamsSQLSourceName = ''@ToolScope,ReleasePackageIllustration''
    RefreshParams = False
