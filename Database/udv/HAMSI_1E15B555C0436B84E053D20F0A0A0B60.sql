...
v_udv_id varchar2(85) :='HAMSI_1E15B555C0436B84E053D20F0A0A0B60';
v_udv_tag varchar2(40) :='HAMSI_PLG_PaarReqUserApprovalDelPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='PAAR Req User Plan Approval Delete Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object UserProfileRemove: TSfSqlSource
    ...
    SelectedFieldsEditControl.Strings = (
      ...
      ''LAST_NAME~Edit''
      ''FIRST_NAME~Edit'')
    InputUDVId = ''HAMSI_1E83700641DB47D7E053D20F0A0A77EA''
    InsUpdDelUDVId = ''HAMSI_1E83700641DB47D7E053D20F0A0A77EA''
