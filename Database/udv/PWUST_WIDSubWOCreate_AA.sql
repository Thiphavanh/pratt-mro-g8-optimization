...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_638990D36FA9FFE5E05387971F0AFFE9.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_638990D36FA9FFE5E05387971F0AFFE9';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_WIDSubWOCreate_AA';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='SMRO_WOE_204';
...
p1 clob :='object TCBScrollBox
  ...
  object Label: TsfLabel
    ...
    Width = 131
    Height = 13
    Caption = ''This should be auto accept ''
    ParentFont = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object SubWOCreatePreWI: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWUST_WOSubWoCreatePre''
    ParamsSQLSourceName = ''@ToolScope,WOSubWOCreateParams''
    RefreshParams = False
  ...
  object WOSubWOCreateParams: TsfTransactionParamSource
    SelectSqlId = ''PWUST_WOSubWOCreateParams''
