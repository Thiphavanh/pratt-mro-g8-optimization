...
v_udv_id varchar2(85) :='PWUE_3783639492DE71C5E053D40F0A0A6143';
v_udv_tag varchar2(40) :='PWUE_WID_PaarReqAuxPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='PWUE WID Paar Req Aux Pnl';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object btnSendRequest: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Send Request,Priv=''#39''{REQUEST_STATUS=''#39#39''OPEN''#39#39''}''#39'',Visible={},TagValue=,'' +
        ''FKey=,Action=ExecSql,ParamsSqlSourceName=srcWidPaarHdrAuxQry,RefreshedSQLSourceName=,SqlID=HAMSI_WID_FIREPAARREVIEW'')
  end
  object btnDisplayOrder: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Display Work Order,Priv={},Visible={},TagValue=,FKey=,Action=Invoke,'' +
        ''Tool=Mfg Instructions,ReportToolId=,Params(''#39''ORDER_ID = :ORDER_ID,''#39'',@InvokeTab=New)'')
  end
  object srcWidPaarHdrAuxQry: TSfSqlSource
    ...
    PublishedSQLSourceName = ''srcWidPaarHdrAuxQry''
  end
end';
v_iclob clob;
begin
