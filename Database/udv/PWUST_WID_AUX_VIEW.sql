...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_636232DFA08BE31EE05387971F0ABFBA.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_636232DFA08BE31EE05387971F0ABFBA';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_WID_AUX_VIEW';
v_udv_type sfcore_udv_lib.udv_type%type  :='PANEL';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect1515,defect1371,defect573,defect710;SMRO_RPT_201,defect771,980,468;SMRO_WOE_304;SMRO_WOE_310;Defect 1381;defect1526;Defect1558;Defect 1614'';Defect 1637;defect 1552,Defect 1976;2016';
...
p1 clob :='object TCBScrollBox
  ...
  object signoff: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        #39#39''IN QUEUE''#39#39'' AND ORDER_ID <> ''#39#39#39#39''}''#39'',''#39''Visible={(1 = 0) AND SIGNON'' +
        ''=''#39#39''N''#39#39'' AND (MRO_FLAG=''#39#39''N''#39#39'' OR ORDER_STATUS<>''#39#39''PENDING''#39#39'') AND SIG'' +
        ''NOFF_ALL_OVERIDE_FLAG=''#39#39''N''#39#39''}''#39'',TagValue=,FKey=,ParamsSrc=@Default'' +
        '',Action=UDV,UDVType=Insert,UDVID=MF1_1001020'')
  end
  object Display: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Delivery Package,Priv=''#39''{ORDER_ID<>''#39#39#39#39''}''#39'',Visible={},TagValu'' +
        ''e=3,FKey=,ParamsSrc=@Default,Action=UDV,UDVType=Insert,UDVID=PWU'' +
        ''ST_68B51C32A390F164E05387971F0ADA16''
  ...
  object _OBJ3: TsfCommandButton
    ...
    Width = 74
    Height = 35
    Hint = ''Select Units for Execution''
  ...
  object StartAlt: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Start Alteration,''#39''Priv={ORDER_ID <> ''#39#39#39#39'' AND @hasPriv(''#39#39''PWU'' +
        ''ST_ALTERATION''#39#39'')}''#39'',Visible=''#39''{MRO_FLAG=''#39#39''Y''#39#39'' AND ORDER_STATUS=''#39#39''P'' +
        ''ENDING''#39#39'' AND OPERATION_OVERLAP_FLAG<>''#39#39''Y''#39#39''}''#39'',TagValue=,FKey=,Par'' +
        ''amsSrc=@Default,Action=UDV,UDVType=Update,UDVID=PWUST_699A6236C8'' +
        ''D6FB2EE05387971F0A2915'')
  end
  object PrintWorkOrder: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Print Work Order,Priv=''#39''{ORDER_ID <> ''#39#39#39#39''}''#39'',Visible={1=0},Ta'' +
        ''gValue=,FKey=,ParamsSrc=@Default,Action=Invoke,Tool=Reporting,Re'' +
        ''portToolId=,Params(''#39''OBJECT_ID=''#39#39''MFI_35555''#39#39'',''#39'',''#39''ORDER_ID=:ORDER_I'' +
        ''D,''#39'',@UserId=:@UserId)'')
  end
  object ApproveScopeChg: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        #39#39#39''}''#39'',TagValue=,FKey=,ParamsSrc=@Default,Action=UDV,UDVType=Inse'' +
        ''rt,UDVID=MFI_78BEF091A2A04CE1E04400144FA7B7D2'')
  end
  ...
  object Partial_Complete: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''ERATION_OVERLAP_FLAG<>''#39#39''Y''#39#39''}''#39'',Visible={1=0},TagValue=,FKey=,Para'' +
        ''msSrc=@Default,Action=UDV,UDVType=Insert,UDVID=MFI_FBA12B1652C84'' +
        ''C569A7454B6EF7AA09B'')
  end
  ...
  object _OBJ17: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Create Sub Order,''#39''Priv={@haspriv(''#39#39''PWUST_SUB_ORDER_CREATE''#39#39 +
        '')}''#39'',''#39''Visible={ORDER_STATUS= ''#39#39''IN QUEUE''#39#39'' or ORDER_STATUS= ''#39#39''ACTI'' +
        ''VE''#39#39'' and  (ORDER_TYPE=''#39#39''Overhaul''#39#39'' OR ORDER_TYPE=''#39#39''OVERHAUL''#39#39'')}''#39 +
        '',TagValue=,FKey=,''#39''ParamsSrc=@Default,DefaultWorkFlow''#39'',Action=UDV'' +
        '',UDVType=Insert,UDVID=PWUST_638990D36FA9FFE5E05387971F0AFFE9''
      
        ''Desc=Standard Sub Order,''#39''Priv={@haspriv(''#39#39''PWUST_SUB_ORDER_CREATE'' +
        #39#39'')}''#39'',''#39''Visible={((ORDER_STATUS= ''#39#39''IN QUEUE''#39#39'') OR (ORDER_STATUS= '' +
        #39#39''ACTIVE''#39#39'')) AND  ((ORDER_TYPE=''#39#39''Repair''#39#39'') OR (ORDER_TYPE=''#39#39''REPA'' +
        ''IR''#39#39''))}''#39'',TagValue=STD,FKey=,''#39''ParamsSrc=@Default,DefaultWorkFlow''#39 +
        '',Action=UDV,UDVType=Insert,UDVID=PWUST_8DBF471E8D738C15E05387971'' +
        ''F0A0130''
      
        ''Desc=Replace Parent Order,''#39''Priv={@haspriv(''#39#39''PWUST_SUB_ORDER_CREA'' +
        ''TE''#39#39'') AND BACKSHOP_REPAIR_ORDER <> ''#39#39''Z002''#39#39''}''#39'',''#39''Visible={(ORDER_S'' +
        ''TATUS= ''#39#39''IN QUEUE''#39#39'' OR ORDER_STATUS= ''#39#39''ACTIVE''#39#39'') and  (ORDER_TYP'' +
        ''E=''#39#39''Repair''#39#39'' OR ORDER_TYPE=''#39#39''REPAIR''#39#39'') and ((@GetQueryValue(PWUS'' +
        ''D_PWUST_SUBSTR_ORDER_1__4) <> ''#39#39''0031''#39#39'') AND (@GetQueryValue(PWUS'' +
        ''D_PWUST_SUBSTR_ORDER_1__4) <> ''#39#39''0030''#39#39''))}''#39'',TagValue=REPLACE,FKey'' +
        ''=,''#39''ParamsSrc=@Default,DefaultWorkFlow''#39'',Action=UDV,UDVType=Insert'' +
        '',UDVID=PWUST_8DBF471E8D738C15E05387971F0A0130''
      
        ''Desc=Rework Sub - Non Billable,''#39''Priv={@haspriv(''#39#39''PWUST_SUB_ORDER'' +
        ''_CREATE''#39#39'') AND BACKSHOP_REPAIR_ORDER <> ''#39#39''Z002''#39#39''}''#39'',''#39''Visible={(OR'' +
        ''DER_STATUS= ''#39#39''IN QUEUE''#39#39'' OR ORDER_STATUS= ''#39#39''ACTIVE''#39#39'') and  (ORDE'' +
        ''R_TYPE=''#39#39''Repair''#39#39'' OR ORDER_TYPE=''#39#39''REPAIR''#39#39'') and (@GetQueryValue('' +
        ''PWUSD_PWUST_SUBSTR_ORDER_1__4) <> ''#39#39''0031''#39#39'')}''#39'',TagValue=REWORK,FK'' +
        ''ey=,''#39''ParamsSrc=@Default,DefaultWorkFlow''#39'',Action=UDV,UDVType=Inse'' +
        ''rt,UDVID=PWUST_8DBF471E8D738C15E05387971F0A0130'')
  end
  object _OBJ18: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Print Traveler,Priv={},Visible={},TagValue=1,FKey=,ParamsSr'' +
        ''c=@Default,Action=UDV,UDVType=Insert,UDVID=PWUST_80873B28A4F2DE8'' +
        ''FE05387971F0AB471'')
  end
  object Scrap: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''Desc=Scrap,''#39''Priv={OPER_NO <> ''#39#39#39#39'' AND ORDER_ID <> ''#39#39#39#39'' AND @hasP'' +
        ''riv(''#39#39''QA_SCRAP''#39#39'')}''#39'',''#39''Visible={ORDER_TYPE = ''#39#39''REPAIR''#39#39'' AND (OPER_'' +
        ''STATUS = ''#39#39''ACTIVE''#39#39'' OR OPER_STATUS = ''#39#39''IN QUEUE''#39#39'')}''#39'',TagValue=,F'' +
        ''Key=,ParamsSrc=@Default,Action=UDV,UDVType=Insert,UDVID=MFI_1287'' +
        ''7493CED647DC9B01D4DD0C73F69E'')
  end
  ...
  object OrderUnitInfoSelect: TSfSqlSource
    SelectOnUserConnection = False
    SelectSqlId = ''PWUST_WID_OrderUnitInfoSelect''
    LinkedControls.Strings = (
      ''Display~''
      ''_OBJ17~'')
