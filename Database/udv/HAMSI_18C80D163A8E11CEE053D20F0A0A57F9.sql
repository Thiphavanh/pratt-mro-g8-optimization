...
v_udv_id varchar2(85) :='HAMSI_18C80D163A8E11CEE053D20F0A0A57F9';
v_udv_tag varchar2(40) :='HAMSI_ApprovalPermissionLocProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for Location Profile in Approval Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object LocationProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_LOCATIONPROFILEIMLOCATIONLOOKUPEXT''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
