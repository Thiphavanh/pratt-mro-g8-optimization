...
v_udv_id varchar2(85) :='HAMSI_19CF71B92B010663E053D20F0A0A7251';
v_udv_tag varchar2(40) :='HAMSI_WID_PAARPermissionsTab';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='PAAR Permissions Tab';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object SoughtPermission: TSfSqlSource
    ...
    SelectSqlId = ''HAMSI_WID_PAARSOUGHTPERMISIONREQUESTSEL''
  ...
  object AuthorisedPermission: TSfSqlSource
    SelectOnUserConnection = False
    SelectSqlId = ''HAMSI_WID_PAARAUTHORISEDPERMISIONSEL''
    LinkedControls.Strings = (
      ''_OBJ2~''
      ''_OBJ4~'')
    ParamsSQLSourceName = ''@ToolScope''
