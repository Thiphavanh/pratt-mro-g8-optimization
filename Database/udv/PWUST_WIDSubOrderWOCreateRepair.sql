...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_8DBF674E213F8E7AE05387971F0ADAEF.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_8DBF674E213F8E7AE05387971F0ADAEF';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_WIDSubOrderWOCreateRepair';
...
p1 clob :='object TCBScrollBox
  ...
  object SerialNo: tSFInputListGrid
    Left = 103
    Top = 170
    Width = 149
    Height = 100
  ...
  object SubWOCreatePreWI: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  Decimal=0''
      ''  Currency=N''
      ''  SqlId=PWUST_OrderSerialNoLookup''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=N''
      ''  DefaultToSingle=N''
      ''  ForceLookup=N''
      ...
      ''  ShortLookupDelim=|''
      ''  VisibleFields''
      ''   SERIAL_NO_LIST=Serial No(15)''
      ''   SERIAL_STATUS=Serial Status(15)''
      ''  Style=Long''
      ''   FilterDefaults''
      ''    FilterCase=N''
      ''    PartialWordMatch=Y''
      ...
      ''  Decimal=0''
      ''  Currency=N''
      ''  SqlId=PWUST_SubOrderSerialNoQty''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=N''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=Y''
      ...
      ''   EFF_FROM_DATE=Eff From Date(16)''
      ''   EFF_THRU_DATE=Eff Thru Date(16)''
      ''  Style=Long''
      ''   FilterDefaults''
      ''    FilterCase=N''
      ''    PartialWordMatch=Y''
    ...
    ParamsSQLSourceName = ''DefaultWorkFlow,OrderOwpSel,@ToolScope,@AuxParams''
    RefreshParams = False
