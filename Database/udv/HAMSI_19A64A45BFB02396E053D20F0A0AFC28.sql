...
v_udv_id varchar2(85) :='HAMSI_19A64A45BFB02396E053D20F0A0AFC28';
v_udv_tag varchar2(40) :='HAMSI_OrderSecGrpApprovalPerLocProIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for Location Profile in Order Sec Grp Approval Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  IMSqlTransactionName = ''LocationProfileOrdSecGrpInsUpd''
  IMSqlSourceName = ''LocationProfile''
  IMScanAction = saIMAccept
  IMAllowHeaderChanges = False
  IMFixedColCount = -1
  IMPopulateFromParams = False
  IMDeleteSqlId = ''HAMSI_ORDERSECGRPAPPROVALPERMISSIONPROFILEDEL''
  ...
  object LocationProfileOrdSecGrpInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_ORDERSECGRPLOCATIONPROFILEIMLOCATIONLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''HAMSI_ORDERSECGRPAPPROVALPERMISSIONPROFILEINS''
    UpdateSqlId = ''HAMSI_ORDERSECGRPAPPROVALPERMISSIONPROFILEUPD''
