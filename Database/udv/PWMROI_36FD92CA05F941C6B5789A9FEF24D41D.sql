...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_36FD92CA05F941C6B5789A9FEF24D41D.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWMROI_3701A7AFD2A14650970AA2A632A73570';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_36FD92CA05F941C6B5789A9FEF24D41D';
v_udv_tag sfcore_udv_lib.udv_tag%type :='ManualTypeIns';
...
p1 clob :='object TCBScrollBox
  ...
  object ManualTypeIns: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWMROI_MANUAL_TYPE_INSERT''
    UpdateSqlId = ''PWMROI_MANUAL_TYPE_UPDATE''
