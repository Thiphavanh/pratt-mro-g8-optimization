...
set define off
prompt ---------------------------------------;
prompt Executing ... MFI_1002186.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='MFI_1000845';
v_udv_id sfcore_udv_lib.udv_id%type  :='MFI_1002186';
v_udv_tag sfcore_udv_lib.udv_tag%type :='AlterationStart';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Start an alteration of wo';
...
p1 clob :='object TCBScrollBox
  ...
  object CHG_AUTH_NUM: TsfDBInputEdit
    Left = 29
    Top = 92
    Width = 135
    Height = 25
...
p2 clob :='MaxLength=1''
  ...
  object GetWOAltCount: TsfTransactionParamSource
