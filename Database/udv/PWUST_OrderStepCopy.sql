...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_738F400331DBD1B7E05387971F0A4D5B.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_738F400331DBD1B7E05387971F0A4D5B';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_OrderStepCopy';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 951, defect 960.';
...
p1 clob :='object TCBScrollBox
  ...
  object OrderStepCopyPre: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''    DelimitedBy=,''
      ''    SearchType=stAnyWords'')
    InsertSqlId = ''OrderStepCopyPre''
    UpdateSqlId = ''OrderStepCopyPre''
    ...
    LinkedControls.Strings = (
      ...
      ''_OBJ7~ORDER_NO''
      ''_OBJ14~OPER_NO''
      ''_OBJ10~TARGET_STEP_NO''
      ''_OBJ11~INCR_BY''
      ''_OBJ3~FROM_ITEM_NO''
      ''_OBJ15~FROM_ITEM_TYPE''
      ''_OBJ4~FROM_ITEM_REV''
      ''_OBJ16~FROM_ITEM_SUBTYPE''
      ''_OBJ12~FROM_ORDER_NO'')
