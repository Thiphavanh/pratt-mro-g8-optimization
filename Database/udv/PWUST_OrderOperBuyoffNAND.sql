...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_65067B37B61D11D2E05387971F0AC8D7.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_65067B37B61D11D2E05387971F0AC8D7';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_OrderOperBuyoffNAND';
...
p1 clob :='object TCBScrollBox
  ...
  object BuyoffReject: TSfSqlTransaction
    InputFieldsSSL.Strings = (
      ...
      '' CharCase=N''
      '' Hidden=False''
      '' Required=TAG_TYPE=''#39''N/A''#39'' OR TAG_TYPE=''#39''REOPEN''#39
      '' PersistManualValues=Y''
      '' MaxLength=4000''
...
p2 clob :='PBUYOFF_VCH4''
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      '' CtrlType=Lookup''
      ''  Currency=N''
      ''  SqlId=PWUST_MFI_WID_GETBUYOFFAVAILABLEUNITS''
      ''  ParamsSrc=@ScriptParams''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
