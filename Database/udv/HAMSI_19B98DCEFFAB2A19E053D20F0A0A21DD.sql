...
v_udv_id varchar2(85) :='HAMSI_19B98DCEFFAB2A19E053D20F0A0A21DD';
v_udv_tag varchar2(40) :='HAMSI_WID_SuggestedPermissionSecGrpPrfIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for Security Group Profile for Suggested Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object SecurityGroupProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_WID_SECURITYGROUPPROFILEIMSECURITYGROUPLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''HAMSI_WID_SUGGESTEDPERMISSIONPROFILEINS''
    UpdateSqlId = ''HAMSI_WID_SUGGESTEDPERMISSIONPROFILEUPD''
