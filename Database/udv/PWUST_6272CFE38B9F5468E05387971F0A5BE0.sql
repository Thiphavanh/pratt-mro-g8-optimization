...
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Clone of MF1_1000987 - SMRO_WOE_206';
...
p1 clob :='object TCBScrollBox
  ...
  object OrderOperDatColSerSel: TSfSqlSource
    ...
    SelectedFields.Strings = (
      ...
      ''STEP_KEY~10~STEP_KEY~N~N~True~False~True~Y~~~~~Default~N~''
      ''OPER_KEY~10~OPER_KEY~N~N~True~False~True~Y~~~~~Default~N~''
      ''REF_ID~0~REF_ID~N~N~True~False~True~Y~~~~~Default~N~''
      
        ''COMPLETE_QTY~6~Complete;Qty~N~N~OPERATION_OVERLAP_FLAG=''#39''N''#39''~False'' +
        ''~True~N~~~~~Default~N~'')
    ...
    TestParamValues.Strings = (
      ...
      ''order_id=MFI_7A12D2415F295E7FE7ED297FADD7B97''
      ''oper_key=381''
      ''step_key=-1''
      ''ref_id=MFI_1DF1A5AD395041379BC01FC6AFFE29E2''
      ''@NavLevelFieldName=ORDER_NO''
      ''@ConsolidatedQueryType=instance''
      ''GROUP_JOB_NO=0000594'')
    OtherCommands.Strings = (
