...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_650197E0C01A44AABA0929B6608BE05A.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_650197E0C01A44AABA0929B6608BE05A';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWMROI_ORD_MANUAL_REV_INPMTX';
...
p1 clob :='object TCBScrollBox
  ...
  IMSqlTransactionName = ''ORDERMANUALREVINP''
  IMSqlSourceName = ''manualorderupdsel''
  ...
  BottomMargin = -1
  object ORDERMANUALREVINP: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    UpdateSqlId = ''PWMROI_UPDATE_ORDERS_MANUAL_REV''
