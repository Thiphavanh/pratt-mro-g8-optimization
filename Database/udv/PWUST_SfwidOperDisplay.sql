...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_863C1EB71F344426E053EF9F1F0A33FB.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_863C1EB71F344426E053EF9F1F0A33FB';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_SfwidOperDisplay';
...
p1 clob :='object TCBScrollBox
  ...
  object SFOR_SfwidOperSelect: TSfSqlSource
    ...
    SelectedFields.Strings = (
      ...
      ''DISC_LINE_NO~5~Line No; ~N~N~False~False~False~N~~~~~Default~N~~''
        ...
        ''UPDT_USERID~10~Update UserID~N~N~False~False~False~N~~~~~Default'' +
        ''~N~~''
  ...
  object SFOR_SfwidSubjectOper: TSfSqlSource
    ...
    SelectedFields.Strings = (
      ...
      ''TITLE~20~Task Group Title~N~N~N~N~N~N~~~~~Default~N~~~''
