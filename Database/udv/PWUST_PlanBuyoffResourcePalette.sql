...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_5E1B397A3BBE89C3E05387971F0AB62D.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_5E1B397A3BBE89C3E05387971F0AB62D';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_PlanBuyoffResourcePalette';
v_udv_type sfcore_udv_lib.udv_type%type  :='PANEL';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='SMRO_WOE_202 Defect 134';
...
p1 clob :='object TCBScrollBox
  ...
  object EmbedBuyoff: TsfCommandButton
    ...
    OtherCommands.Strings = (
        ...
        ''=,ParamsSrc=EmbedBuyoffSelectOper,Action=DragDrop,DropCmd='')
  end
  ...
  object EmbedBuyoffSelectOper: TSfSqlSource
    ...
    SelectedFields.Strings = (
        ...
        ''BUYOFF_CERT~12~Req''#39''d Cert~N~N~False~False~False~N~~~~~Default~N~'' +
        ''~''
    ...
    TestParamValues.Strings = (
      ''@whereClause=''#39#39
      ''PLAN_ID=MFI_1'')
    InputUDVId = ''MF1_1000530''
    InsertUDVId = ''MF1_1000530''
    InsUpdDelUDVId = ''MF1_1000530''
    DropCommands.Strings = (
      ''Buyoff~MF1_1000530~EmbedBuyoffSelectOper~InputMatrix~'')
    ...
    PublishedSQLSourceName = ''EmbedBuyoffSelectOper''
