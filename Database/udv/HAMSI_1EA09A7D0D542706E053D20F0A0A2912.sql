...
v_udv_id varchar2(85) :='HAMSI_1EA09A7D0D542706E053D20F0A0A2912';
v_udv_tag varchar2(40) :='HAMSI_PaarAppPermOrderFacilityRmvlROPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='PAAR Order Perm Approval Facility Removal RO Panel';
v_state varchar2(10) :='';
