...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_5D907818F49E6DB6E05387971F0A5C0A.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_5D907818F49E6DB6E05387971F0A5C0A';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_CREATE_OVERHAUL_ORDERS_PRE';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect 519; Defect 885; Defect 890';
...
p1 clob :='object TCBScrollBox
  ...
  object CREATE_ORDER: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''NEW_PART_NO''
      '' CtrlType=Lookup''
      ''  SqlId=PWUST_SEL_OVERHAUL_PARTS''
      ''  ParamsSrc=DEFAULT_PARAMS''
      ''  Validate=Y''
      ''  DefaultToSingle=N''
      ''  ForceLookup=N''
      ''  IMLookupFilter=N''
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWUST_createMroOverhaulOrdersSelectUDV''
    UpdateSqlId = ''PWUST_createMroOverhaulOrdersSelectUDV''
    ParamsSQLSourceName = ''DEFAULT_PARAMS,@ToolScope''
    RefreshParams = False
    LinkedControls.Strings = (
      ...
      ''_OBJ6~NEW_PLANNED_ORDER_FLAG''
      ''_OBJ7~INPUT_MATRIX_FLAG''
      ''_OBJ8~NEW_PART_NO''
      ''_OBJ4~NEW_SAP_WORK_LOC''
      ''customer~NEW_CUSTOMER_NO'')
  ...
  object DEFAULT_PARAMS: TsfTransactionParamSource
    SelectSqlId = ''PWUST_DefaultCreateOrderParams''
    PublishParams = True
  end
end';
v_iclob clob;
