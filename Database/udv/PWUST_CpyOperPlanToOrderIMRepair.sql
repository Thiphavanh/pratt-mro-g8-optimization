...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_7D7B62E1627844AFE05387971F0A5D05.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_7D7B62E1627844AFE05387971F0A5D05';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_CpyOperPlanToOrderIMRepair';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPMTX';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect 1044';
...
p1 clob :='object TCBScrollBox
  ...
  object PlanToOrderOperCopyIns: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    UpdateSqlId = ''PlanToOrderOperCopyIns''
  ...
  object PlanToOrderOperCopy: TSfSqlSource
    ...
    TestParamValues.Strings = (
      ...
      ''plan_alterations=0''
      ''oper_no_list=010''
      ''from_plan_id=MFI_324D8FB2441E00D3AA2181B5D6B448A2''
      ''from_plan_version=1''
