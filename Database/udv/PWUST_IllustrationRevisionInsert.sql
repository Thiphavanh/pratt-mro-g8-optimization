...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_C46C7F511FFFAADBE05387971F0AB628.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_C46C7F511FFFAADBE05387971F0AB628';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_IllustrationRevisionInsert';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='DEFECT 1906 IllustrationRevisionInsert';
...
p1 clob :='object TCBScrollBox
  ...
  object IllustrationIns: TSfSqlTransaction
    InputFieldsSSL.Strings = (
      ...
      ''RELEASE_PACKAGE''
      '' Update=CHANGE_REQUEST_ID<>''#39#39'' AND RELEASE_PACKAGE<>''#39#39
      '' Insert=CHANGE_REQUEST_ID<>''#39#39'' AND RELEASE_PACKAGE<>''#39#39
      '' PopulateForInsert=Y''
      '' CharCase=N''
      '' PersistManualValues=Y''
      '' Hidden=False''
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  Decimal=0''
      ''  Currency=N''
      ''  SqlId=MFI_ILLUSTRATION_DOCTYPE_SEL''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
      ''  IMLookupFilter=N''
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWUST_IllustrationsRevisionIns''
    CancelSqlId = ''MFI_PLG_CLEARTAKEACTIONSESSIONVALUES''
    UpdateSqlId = ''MFI_FND_IllustrationsRevisionIns''
    ParamsSQLSourceName = ''@AuxParams,@ToolScope,Select''
    RefreshParams = False
    LinkedControls.Strings = (
      ''_OBJ2~OBJECT_DESC''
      ''_OBJ1~OBJECT_TAG''
      ''_OBJ3~CLASSIFICATION''
      ''_OBJ4~RELEASE_PACKAGE''
  ...
  object Select: TsfTransactionParamSource
    SelectSqlId = ''MFI_FND_IllustrationSourceSel''
