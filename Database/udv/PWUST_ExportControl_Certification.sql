...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_5A92ABA507DB681FE05387971F0A8C40.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_5A92ABA507DB681FE05387971F0A8C40';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_ExportControl_Certification';
...
p1 clob :='object TCBScrollBox
  ...
  Height = 300
  AutoScroll = False
  Caption = ''Export Approver Certication Statement''
  ...
  object GetCertMessage: TsfTransactionParamSource
    SelectSqlId = ''PWUST_ExportControl_GetCertMsg''
    ParamsSQLSourceName = ''@ScriptParams''
    PublishParams = True
  end
  object GetCertMsgPassThruTrans: TsfSqlTransaction
    ...
    ParamsSQLSourceName = ''GetCertMessage''
    RefreshParams = False
