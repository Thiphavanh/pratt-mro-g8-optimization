...
v_udv_id varchar2(85) :='HAMSI_169690B190C06C4CE053D20F0A0AE7C0';
v_udv_tag varchar2(40) :='HAMSI_SuggestedPermissionUserProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for User Profile in Suggested Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object UserProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_USERPROFILEIMUSERLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
