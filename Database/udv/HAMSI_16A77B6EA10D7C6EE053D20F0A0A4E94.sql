...
v_udv_id varchar2(85) :='HAMSI_16A77B6EA10D7C6EE053D20F0A0A4E94';
v_udv_tag varchar2(40) :='HAMSI_PLG_PaarReqFacilitySghtPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='HAMSI PLG Paar Req Facility Sght Panel';
v_state varchar2(10) :='';
