...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_63EE5BAD458C5864E05387971F0A48CC.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_63EE5BAD458C5864E05387971F0A48CC';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_NANDBuyoffStatusComment';
...
p1 clob :='object TCBScrollBox
  ...
  object BuyoffReject: TsfSqlTransaction
    InputFieldsSSL.Strings = (
      ...
      '' PopulateForInsert=N''
      '' CharCase=N''
      '' Required=ORDER_CONTROL_TYPE=''#39''NONE''#39'' AND GROUP_JOB_NO =''#39#39
      '' MaxLength=40''
      '' Hidden=ORDER_CONTROL_TYPE<>''#39''NONE''#39'' OR GROUP_JOB_NO<>''#39#39
      ...
      '' CharCase=Y''
        ...
        ''R ORDER_CONTROL_TYPE=''#39''LOT''#39'' OR GROUP_JOB_NO<>''#39#39
...
p2 clob :='orInsert=Y''
      ...
      '' CharCase=N''
        ...
        '' Hidden=(STATUS=''#39''REJECT''#39'') OR (STATUS=''#39''REOPEN''#39'') OR (PARTIAL_COMPL'' +
        ''ETE<>''#39''QTY''#39'' AND  OPERATION_OVERLAP_FLAG<>''#39''Y''#39'')''
      
        '' Required=STATUS=''#39''PARTIAL''#39'' AND PARTIAL_COMPLETE=''#39''QTY''#39'' OR OPERATI'' +
        ''ON_OVERLAP_FLAG=''#39''Y''#39
      '' PersistManualValues=Y''
      ''PERCENT_COMPLETE''
      '' AuxField=Y''
      '' Update=False''
