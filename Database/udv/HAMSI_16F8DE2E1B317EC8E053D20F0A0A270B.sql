...
v_udv_id varchar2(85) :='HAMSI_16F8DE2E1B317EC8E053D20F0A0A270B';
v_udv_tag varchar2(40) :='HAMSI_SuggestedPermissionSecGrpProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix for Security Group Profile in Suggested Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object SecurityGroupProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_SECURITYGROUPPROFILEIMSECURITYGROUPLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
