...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_651ED675EE46050EE05387971F0A7AF8.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_651ED675EE46050EE05387971F0A7AF8';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_CREATE_PLANNDEDOVERHAUL_ORDERS';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect 380,1836,1844';
...
p1 clob :='object TCBScrollBox
  ...
  object _OBJ21: TsfLabel
    Left = 62
    Top = 4
    Width = 200
    Height = 17
    Caption = ''Begin Planned Order Processing''
    ParentFont = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object CREATE_Planned_ORDER: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''Pwust_create_planned_order''
    ParamsSQLSourceName = ''Overhaul_planned_orders,@ToolScope''
    RefreshParams = False
    LinkedControls.Strings = (
      ...
      ''_OBJ13~CUSTOMER''
      ''_OBJ15~PLAN_VERSION''
      ''_OBJ16~PLAN_REVISION''
      ''_OBJ20~PLAN_ALTERATIONS'')
    MultiRecordTransaction = mruTrue
    RefreshedSQLSourceName = ''Overhaul_planned_orders''
