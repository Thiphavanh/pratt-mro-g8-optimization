...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUSD_9EAB5323B577BB6AE05387971F0AC7EA.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUSD_9EAB5323B577BB6AE05387971F0AC7EA';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUSD_9EAB5323B577BB6AE05387971F0AC7EA';
v_udv_type sfcore_udv_lib.udv_type%type  :='PANEL';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect1354';
...
p1 clob :='object TCBScrollBox
  ...
  object StdOperSecurityGroupSel: TSfSqlSource
    ...
    SelectSqlId = ''PWUSD_MFI_StdOperSecurityGroupSel''
