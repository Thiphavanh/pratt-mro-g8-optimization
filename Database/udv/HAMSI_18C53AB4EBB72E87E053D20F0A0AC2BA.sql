...
v_udv_id varchar2(85) :='HAMSI_18C53AB4EBB72E87E053D20F0A0AC2BA';
v_udv_tag varchar2(40) :='HAMSI_ApprovalPermissionUserProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix For User Profile in Approval Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  object UserProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_SECGRPUSERPROFILEIMUSERLOOKUPEXT''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
      ...
      ''   WORK_LOC=Home Work Loc(10)''
      ''   WORK_DEPT=Home Work Dept(10)''
      ''   WORK_CENTER=Home Work Ctr(10)''
      ''  Style=Long''
      ''   FilterDefaults''
      ''    FilterCase=N''
      ''    PartialWordMatch=Y''
