...
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Display open + delivered serials of order;Defect1611';
  ...
  object repairWODeliverAll: TSfSqlSource
    ...
    SelectedFields.Strings = (
      ''SERIAL_NO~10~Serial No.~N~N~False~False~False~N~~~~~Default~N~~~''
        ...
        ''UCF_SERIAL_VCH10~15~Deliver Serial Status~N~N~False~False~False~'' +
        ''N~~~~~Default~N~~~''
