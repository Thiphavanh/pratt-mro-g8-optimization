...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_34AA97DA06E141FEAA77CA670B34C0F8.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWMROI_3701A7AFD2A14650970AA2A632A73570';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_34AA97DA06E141FEAA77CA670B34C0F8';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWMROI_MANUAL_PLANS_USED';
...
p1 clob :='object TCBScrollBox
  ...
  object manualplansused: TSfSqlSource
    ...
    SelectSqlId = ''PWMROI_MANUAL_PLAN_USED_SEL''
    ...
    SelectedFields.Strings = (
      ...
      ''SUBJECT_NO~4~Task Group~N~N~False~False~False~N~~~~~Default~N~~~''
        ...
        ''SUBJECT_TITLE~12~Task Group Title~N~N~False~False~False~N~~~~~De'' +
        ''fault~N~~~''
      ''PART_NO~12~Part~N~N~False~False~False~N~~~~~Default~N~~~''
