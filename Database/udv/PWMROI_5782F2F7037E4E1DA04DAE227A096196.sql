...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_5782F2F7037E4E1DA04DAE227A096196.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWMROI_3701A7AFD2A14650970AA2A632A73570';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_5782F2F7037E4E1DA04DAE227A096196';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWMROI_SfplPlanSubjectUpd';
...
p1 clob :='object TCBScrollBox
  ...
  object SFOR_SfplPlanSubject: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWMROI_SfplPlanSubjectIns''
    UpdateSqlId = ''PWMROI_SfplPlanSubjectUpd''
    ParamsSQLSourceName = 
  ...
  object SFOR_SfplPlanSubjectNewtNoSel: TsfTransactionParamSource
    SelectSqlId = ''PWMROI_SfplPlanSubjectNewtNoSel''
