...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_10EE7647778F4B4398789C432E3865CC.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_10EE7647778F4B4398789C432E3865CC';
v_udv_tag sfcore_udv_lib.udv_tag%type :='DeliverAll';
...
p1 clob :='object TCBScrollBox
  ...
  object SendSerialToDeliver: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWMROI_INITIATEDELIVERY''
