...
set define off
prompt ---------------------------------------;
prompt Executing ... MFI_C5F173F2C8A547D4B8B0AD266FC6AD37.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='FOUNDATION';
v_udv_id sfcore_udv_lib.udv_id%type  :='MFI_C5F173F2C8A547D4B8B0AD266FC6AD37';
v_udv_tag sfcore_udv_lib.udv_tag%type :='SfplStdOperSaveAs';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Save as StdOper;Defect1354';
...
p1 clob :='object TCBScrollBox
  ...
  object StdOperCreate: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''    DelimitedBy=,''
      ''    SearchType=stAnyWords'')
    InsertSqlId = ''MFI_PLG_StdOperSaveAs''
