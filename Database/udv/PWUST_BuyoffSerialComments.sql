...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_B67AA3449DB94DA8E053EF9F1F0A2219.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_B67AA3449DB94DA8E053EF9F1F0A2219';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_BuyoffSerialComments';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 1003 Display serialNos and Comments';
...
p1 clob :='object TCBScrollBox
  ...
  Caption = 
    ''@Lookup(STATUS,''#39''PARTIAL:Partial Comments,REOPEN:Reopen Comments,'' +
    ''ACCEPT:Buyoff Status Comments''#39'',''#39''Comment''#39'')''
  ...
  object _OBJ3: TsfDBInputMemo
    ...
    Ctl3d = True
    MemoCaption = 
      ''@Lookup(STATUS,''#39''PARTIAL:Comment*,REOPEN:Comment*,ACCEPT:Comment''#39 +
      '',''#39''Comment''#39'')''
    CaptionPos = cpLeft
  ...
  object BuyoffReopen: TSfSqlTransaction
    InputFieldsSSL.Strings = (
      ...
      '' CharCase=Y''
        ...
        '' Hidden=(ORDER_CONTROL_TYPE<>''#39''SERIAL1''#39'' AND ORDER_CONTROL_TYPE<>''#39 +
        ''SERIAL''#39'') OR GROUP_JOB_NO<>''#39#39
      ...
      '' CharCase=N''
      '' Hidden=False''
      '' Required=STATUS=''#39''PARTIAL''#39'' OR STATUS = ''#39''REOPEN''#39
      '' PersistManualValues=Y''
      '' MaxLength=4000''
...
p2 clob :=' ''UCF_SRLOPBUYOFF_VCH3''
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  ParamsSrc=@Toolscope,@ScriptParams''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  ForceLookup=N''
      ''  IMLookupFilter=N''
  ...
  object BuyoffPercentComplete: TsfTransactionParamSource
    SelectSqlId = ''PWUST_MFI_WID_BuyoffPecentCompleteSel_Alt''
