...
v_udv_id varchar2(85) :='HAMSI_19A698F26BBB2EDDE053D20F0A0AE042';
v_udv_tag varchar2(40) :='HAMSI_ApprovalPerOrderSecGrpProfileIM';
v_udv_type varchar2(7) :='INPMTX';
v_udv_desc varchar2(255) :='Input Matrix For Order Security Profile in Appproval Permission Panel';
v_state varchar2(10) :='';
...
p1 clob :='object TCBScrollBox
  ...
  IMSqlTransactionName = ''OrdSecurityGroupProfileInsUpd''
  ...
  object OrdSecurityGroupProfileInsUpd: TsfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''PMN_TYPE_ENTITY''
      '' CtrlType=Lookup''
      ''  SqlId=HAMSI_ORDERSECURITYGROUPPROFILEIMSECURITYGROUPLOOKUP''
      ''  ParamsSrc=@ToolScope''
      ''  Validate=Y''
      ''  DefaultToSingle=Y''
      ''  IMLookupFilter=N''
