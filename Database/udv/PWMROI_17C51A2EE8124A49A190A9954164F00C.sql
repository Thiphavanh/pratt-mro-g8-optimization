...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_17C51A2EE8124A49A190A9954164F00C.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWMROI_17C51A2EE8124A49A190A9954164F00C';
v_udv_tag sfcore_udv_lib.udv_tag%type :='InsertManualRevision';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='defect 1670';
...
p1 clob :='object TCBScrollBox
  ...
  object ManualReviIns: TSfSqlTransaction
    ...
    InputFieldsEditControlSSL.Strings = (
      ...
      ''  AllowManaging=N''
      ''  SelectFolder=N'')
    InsertSqlId = ''PWMROI_MANUAL_INSERT''
    ParamsSQLSourceName = ''@ToolScope''
    RefreshParams = False
    LinkedControls.Strings = (
      ''_OBJ1~MANUAL_NO''
      ''_OBJ2~MANUAL_REV''
      ''_OBJ3~MANUAL_TRANSMITTAL_NO''
      ''_OBJ4~MANUAL_RELEASE_DATE''
      ''_OBJ6~MANUAL_TITLE''
      ''_OBJ7~ENGINE_SERIES''
      ''_OBJ8~MANUAL_PROVIDER''
      ''_OBJ9~MANUAL_TYPE''
      ''_OBJ5~MANUAL_REMARKS'')
