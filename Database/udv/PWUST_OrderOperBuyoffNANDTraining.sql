...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUSD_A3D4C0B47ADF6BA3E05387971F0A482B.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUSD_A3D4C0B47ADF6BA3E05387971F0A482B';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_OrderOperBuyoffNANDTraining';
v_udv_type sfcore_udv_lib.udv_type%type  :='INPUT';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='SMRO_WOE_302 - Buyoffs; Defect 1555';
