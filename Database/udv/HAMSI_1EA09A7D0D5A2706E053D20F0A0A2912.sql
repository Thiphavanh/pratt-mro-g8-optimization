...
v_udv_id varchar2(85) :='HAMSI_1EA09A7D0D5A2706E053D20F0A0A2912';
v_udv_tag varchar2(40) :='HAMSI_PLG_PaarApprovalSecGrpDelROPnl';
v_udv_type varchar2(7) :='PANEL';
v_udv_desc varchar2(255) :='Paar Request Sec Group in Approval Delete RO Panel';
v_state varchar2(10) :='';
