CREATE OR REPLACE VIEW PWUST_OVERHAUL_WO_DISPATCH_V AS
SELECT distinct
...
GRANT SELECT ON PWUST_OVERHAUL_WO_DISPATCH_V TO pratt_read_only ;
GRANT SELECT ON PWUST_OVERHAUL_WO_DISPATCH_V TO sf$connection_pool ;