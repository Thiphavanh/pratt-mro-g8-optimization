...
SELECT  TT.SALES_ORDER AS SALES_ORDER,
        ...
        (SELECT T1.ALT_REASON FROM SFWID_ALTERATION_DESC T1 WHERE T1.ALT_ID = T.ALT_ID) AS REASON_FOR_CHANGE,
         T.SECURITY_GROUP,
         T.UCF_ORDER_VCH14 AS RELEASED_BY,
...
GRANT SELECT ON PWUST_OVERHAUL_WO_DISP_TAB_V TO pratt_read_only ;
GRANT SELECT ON PWUST_OVERHAUL_WO_DISP_TAB_V TO sf$connection_pool ;
