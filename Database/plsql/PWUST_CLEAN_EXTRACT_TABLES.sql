CREATE OR REPLACE PROCEDURE PWUST_CLEAN_EXTRACT_TABLES(VI_PART_NO             VARCHAR2,
  ...
  -- 2018-03-27    R. Cannon       --       Initial Release
  -- ****************************************************************************
   ...
   --Part Number Validation
    ...
    BEGIN
      ...
      LOOP
        ...
        --DELETE FROM VIS_LIB_STANDARD_TEXT; --Table unused with initial release of migration code
        --DELETE FROM VIS_STANDARD_OPERATION; --Table unused with initial release of migration code
