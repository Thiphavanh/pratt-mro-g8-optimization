...
v_sql_id varchar2(85) :='HAMSI_ORDERSECGRPPERMISSIONSTAB';
v_sql_id_displ varchar2(85) :='HAMSI_OrderSecGrpPermissionsTab';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Order Security Group Permissions Tab';
v_sql_text varchar2(4000) :='SELECT A.REQUEST_ID,
       ...
       A.TIME_STAMP,
       A.LAST_ACTION
  FROM UTASGE_WID_PAAR_PMN_AUTH A
