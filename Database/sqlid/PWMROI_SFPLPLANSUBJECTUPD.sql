...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_SFPLPLANSUBJECTUPD.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWMROI_721CCDAC8C2341B8A268719CCA67FBCE';
v_sql_id sfcore_sql_lib.sql_id%type :='PWMROI_SFPLPLANSUBJECTUPD';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWMROI_SfplPlanSubjectUpd';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='';
v_description sfcore_sql_lib.description%type  :='SFOR Subject Update';
v_sql_text sfcore_sql_lib.sql_text%type  :='EXEC com.pw.solumina.authority.application.impl.AuthorityImpl.updateSubjectTaskGroup (:PLAN_ID,:PLAN_VERSION,:PLAN_REVISION,:PLAN_ALTERATIONS ,:SUBJECT_NO,:TITLE,:IS_DEFAULT,
