...
v_sql_id varchar2(85) :='HAMSI_WID_PAARSOUGHTPERMISIONREQUESTSEL';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PAARSoughtPermisionRequestSel';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='SELECT A.REQUEST_ID,
       ...
       A.LAST_ACTION,
       '''' AS SECURITY_GROUP
  FROM UTASGI_WID_PAAR_PMN_SGHT A
