...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_PL_WORKLOCSEL2.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_PL_WORKLOCSEL2';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_Pl_WorkLocSel2';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='';
v_description sfcore_sql_lib.description%type  :='Lookup for sfpl_work_loc';
v_sql_text sfcore_sql_lib.sql_text%type  :='SELECT WORK_LOC AS PLND_WORK_LOC,
       LOC_TITLE,
       COMPANY,
       LOC.LOCATION_ID AS PLND_LOCATION_ID
