...
v_udv_desc sfcore_udv_lib.udv_desc%type  :='org udv id = MF1_1000775';
...
p1 clob :='object TCBScrollBox
  ...
  object PlanHdrSel: TSfSqlSource
    ...
    LinkedControls.Strings = (
      ...
      ''_OBJ59~UCF_PLAN_VCH3''
      ''_OBJ60~UCF_PLAN_VCH4''
    ...
    SelectedFields.Strings = (
      ...
      ''PART_NO~50~PART_NO~N~N~MRO_FLAG = ''#39''Y''#39''~N~False~N~~~~~Default~N~~''
      ...
      ''MFG_BOM_CHG~4~MFG_BOM_CHG~N~N~True~N~False~N~~~~~Default~N~~''
      ...
      ''LOCK_STATE~20~LOCK_STATE~N~N~N~N~False~N~~~~~Default~N~~''
        ...
        ''NEEDS_REVIEW_FLAG~1~NEE';
p2 clob :='DS_REVIEW_FLAG~N~N~N~N~False~N~~~~~Defaul'' +
        ''t~N~~''
      ''SERIAL_FLAG~1~SERIAL_FLAG~N~N~N~N~False~N~~~~~Default~N~~''
      ''LOT_FLAG~1~LOT_FLAG~N~N~N~N~False~N~~~~~Default~N~~''
      
        ''UCF_PLAN_VCH1~4~Classification;Code~N~N~Y~N~False~N~~~~~Default~'' +
        ''N~~''
      ''UCF_PLAN_VCH2~30~Mission~N~N~Y~N~False~N~~~~~Default~N~~''
      ''UCF_PLAN_VCH3~10~ADC''#39''s Badge No~N~N~Y~N~False~N~~~~~Default~N~~''
      ...
      ''UCF_PLAN_NUM1~10~Sigma;Category~N~N~Y~N~N~N~~~~~Default~N~~''
        ...
        ''~~''
      ''BOM_NO~40~BOM_NO~N~N~True~False~False~N~~~~~Default~N~~''
        ...
        ''DISPLAY_SEQUENCE~0~DISPLAY_SEQUENCE~N~N~True~False~False~N~~~~~D'' +
        ''efault~N~~'')
