...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_MFI_WID_ORDEROPERATIONINSERT.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_MFI_WID_ORDEROPERATIONINSERT';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='pwust_MFI_WID_OrderOperationInsert';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='';
v_description sfcore_sql_lib.description%type  :='Insert Operation in Order;defect 760, defect 1852';
v_sql_text sfcore_sql_lib.sql_text%type  :='EXEC com.pw.solumina.sfwid.application.impl.OperationImplPW.insertAlteration(
    :ORDER_ID,
    :OPER_NO,
    :OPER_TYPE,
    :OPER_OPT_FLAG,
