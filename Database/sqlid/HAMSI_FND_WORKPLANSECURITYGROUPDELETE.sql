...
v_sql_id varchar2(85) :='HAMSI_FND_WORKPLANSECURITYGROUPDELETE';
v_sql_id_displ varchar2(85) :='HAMSI_FND_WorkPlanSecurityGroupDelete';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Cloned from MFI_FND_WorkPlanSecurityGroupDelete';
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sffnd.application.IUtasSecurityGroup.deleteWorkPlanSecurityGroup(:PLAN_NO,
                                                                                         NULL,
                                                                                         NULL,
                                                                                         NULL,                                                                                        
                                                                                         NULL,
