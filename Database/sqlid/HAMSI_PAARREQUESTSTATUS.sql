...
v_sql_id varchar2(85) :='HAMSI_PAARREQUESTSTATUS';
v_sql_id_displ varchar2(85) :='HAMSI_PAARRequestStatus';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Request Status';
v_sql_text varchar2(4000) :='SELECT A.REQUEST_STATUS, A.REQUEST_ID
