...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_68AE6419C976F144E05387971F0A39FA.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_udv_folder.folder_id%type :='PWUST_550FF0D87F4141A0E05387971F0AD3EA';
v_udv_id sfcore_udv_lib.udv_id%type  :='PWUST_68AE6419C976F144E05387971F0A39FA';
v_udv_tag sfcore_udv_lib.udv_tag%type :='PWUST_SFOR_SfwidOrderSub';
v_udv_type sfcore_udv_lib.udv_type%type  :='PANEL';
v_udv_desc sfcore_udv_lib.udv_desc%type  :='Defect 426 / 1218';
...
p1 clob :='object TCBScrollBox
  ...
  object SFOR_SfwidOrderSubject: TSfSqlSource
    ...
    SelectSqlId = ''PWUST_SFOR_SfwidOrderSubject''
    ...
    SelectedFields.Strings = (
      ...
      ''TITLE~30~Title; ~N~N~N~N~N~N~~~~~Default~N~~''
      
        ''SUPERIOR_NETWORK_ACT~4~Activity No~N~N~False~False~False~N~~~~~D'' +
        ''efault~N~~''
      
        ''SUB_NETWORK_ACT~4~Sub Activity No~N~N~False~False~False~N~~~~~De'' +
        ''fault~N~~''
