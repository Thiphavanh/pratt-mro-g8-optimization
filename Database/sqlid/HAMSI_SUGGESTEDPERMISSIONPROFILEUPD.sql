...
v_sql_id varchar2(85) :='HAMSI_SUGGESTEDPERMISSIONPROFILEUPD';
v_sql_id_displ varchar2(85) :='HAMSI_SuggestedPermissionProfileUpd';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfpl.application.IUtasPlan.updateProfile(:REQUEST_ID, :SGHT_ID, :PMN_EFF_FROM_DATE, :PMN_EFF_THRU_DATE)';
begin
begin
