...
set define off
prompt ---------------------------------------;
prompt Executing ... HAMSI_SECGRPUSERPROFILEIMUSERLOOKUPEXT.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='FOUNDATION';
v_sql_id sfcore_sql_lib.sql_id%type :='HAMSI_SECGRPUSERPROFILEIMUSERLOOKUPEXT';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='HAMSI_SecGrpUserProfileIMUserLookupExt';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='SFWID';
v_description sfcore_sql_lib.description%type  :='User Lookup in User Profile for Ext Input Matrix';
