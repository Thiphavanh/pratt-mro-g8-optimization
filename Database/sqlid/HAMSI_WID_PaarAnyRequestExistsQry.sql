...
v_sql_id varchar2(85) :='HAMSI_WID_PAARANYREQUESTEXISTSQRY';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarAnyRequestExistsQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Order Requests - Any Request Exists';
v_sql_text varchar2(4000) :='select decode(count(*),0,''N'',''Y'') as any_request_exists from utasgi_wid_paar_desc where order_id = :order_id';
