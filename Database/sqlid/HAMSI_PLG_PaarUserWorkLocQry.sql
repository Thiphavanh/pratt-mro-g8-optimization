...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARUSERWORKLOCQRY';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarUserWorkLocQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Requests - User Work Locs with Security';
v_sql_text varchar2(4000) :='select work_loc as asgnd_work_loc, loc_title 
