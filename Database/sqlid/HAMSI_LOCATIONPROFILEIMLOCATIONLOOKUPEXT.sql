...
v_sql_id varchar2(85) :='HAMSI_LOCATIONPROFILEIMLOCATIONLOOKUPEXT';
v_sql_id_displ varchar2(85) :='HAMSI_LocationProfileIMLocationLookupExt';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Location Lookup in Location Profile For External Input Matrix';
