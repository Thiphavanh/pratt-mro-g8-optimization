...
v_sql_id varchar2(85) :='HAMSI_SUGGESTEDPERMISSIONPROFILEDEL';
v_sql_id_displ varchar2(85) :='HAMSI_SuggestedPermissionProfileDel';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfpl.application.IUtasPlan.deleteSuggestedPermissionProfile(:SGHT_ID, :REQUEST_ID, :PMN_ACTION)';
begin
begin
