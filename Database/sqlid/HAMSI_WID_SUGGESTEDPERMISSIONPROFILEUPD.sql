...
v_sql_id varchar2(85) :='HAMSI_WID_SUGGESTEDPERMISSIONPROFILEUPD';
v_sql_id_displ varchar2(85) :='HAMSI_WID_SuggestedPermissionProfileUpd';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Update Sql for Profile in Suggested Permission Panel';
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfwid.application.IUtasOrderExt.updateProfile(:REQUEST_ID, :SGHT_ID, :PMN_EFF_FROM_DATE, :PMN_EFF_THRU_DATE)';
begin
begin
