...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_BUYOFFCERTLOOKUP.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_BUYOFFCERTLOOKUP';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_BuyoffCertLookup';
...
v_sql_text sfcore_sql_lib.sql_text%type  :='select loc.work_loc, c.cert  as Buyoff_Cert,  decode(c.description,null,''...'',description) as Description,p.security_group
...
union
select null as work_loc, c.cert  as Buyoff_Cert,  decode(c.description,null,''...'',description) as Description, null as security_group
  from sffnd_work_loc_def loc, sffnd_company_def comp,
