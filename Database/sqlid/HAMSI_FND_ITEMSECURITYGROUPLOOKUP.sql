...
v_sql_id varchar2(85) :='HAMSI_FND_ITEMSECURITYGROUPLOOKUP';
v_sql_id_displ varchar2(85) :='HAMSI_FND_ItemSecurityGroupLookup';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Clonned From MFI_FND_ItemSecurityGroupLookup';
...
WHERE
    ...
    AND SECURITY_GROUP NOT IN (SELECT SECURITY_GROUP
                            FROM  SFPL_ITEM_DESC_SEC_GRP WHERE PART_NO = :PART_NO)
