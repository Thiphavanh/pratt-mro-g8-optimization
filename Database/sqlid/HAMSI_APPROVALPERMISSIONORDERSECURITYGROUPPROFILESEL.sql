...
v_sql_id varchar2(85) :='HAMSI_APPROVALPERMISSIONORDERSECURITYGROUPPROFILESEL';
v_sql_id_displ varchar2(85) :='HAMSI_ApprovalPermissionOrderSecurityGroupProfileSel';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Select Security Group Profile in Approval Permission Order Security Group Grid';
