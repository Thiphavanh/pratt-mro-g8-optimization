...
set define off
prompt ---------------------------------------;
prompt Executing ... ORDER_OPER_DISPATCH2.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='FOUNDATION';
v_sql_id sfcore_sql_lib.sql_id%type :='ORDER_OPER_DISPATCH2';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='Order_Oper_Dispatch2';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='SFWID';
v_description sfcore_sql_lib.description%type  :='SMRO_WOE_208';
...
SELECT
   ...
   END_UNIT_NO, END_UNIT_TYPE,B.OPERATION_OVERLAP_FLAG, B.INCOMINGSO, B.OUTGOINGSO
from   SFMFG.sfwid_order_opers_disp_data d
   ...
   (
      SELECT
       ...
       o.UNIT_NO AS END_UNIT_NO, o.UNIT_TYPE AS END_UNIT_TYPE,o.OPERATION_OVERLAP_FLAG, o.UCF_ORDER_VCH11 as INCOMINGSO, o.UCF_ORDER_VCH12 as OUTGOINGSO
      from         SFMFG.SFWID_ORDER_DESC o
         left join SFMFG.SFWID_LOT_DESC LD on LD.ORDER_ID = o.ORDER_ID
      group by o.Order_ID,o.SERIAL_FLAG,o.LOT_FLAG,o.ORDER_QTY,o.INSP_ORDER_ID,SPLIT_FROM_ORDER_ID, o.UNIT_NO, o.UNIT_TYPE,o.OPERATION_OVERLAP_FLAG, o.UCF_ORDER_VCH11, o.UCF_ORDER_VCH12
