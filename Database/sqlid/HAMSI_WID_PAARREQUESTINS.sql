...
v_sql_id varchar2(85) :='HAMSI_WID_PAARREQUESTINS';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PAARRequestIns';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Create Work Order PAAR Request';
v_sql_text varchar2(4000) :='exec com.utas.solumina.sfwid.application.IUtasOrderExt.requestPaarReview(:order_id, :@TAG)';
begin
begin
