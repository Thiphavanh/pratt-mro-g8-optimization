...
v_sql_id varchar2(85) :='HAMSI_APPROVALPERMISSIONPROFILEDEL';
v_sql_id_displ varchar2(85) :='HAMSI_ApprovalPermissionProfileDel';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Delete Sql for Approval Permission Profile';
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfpl.application.IUtasPlan.deleteApprovalPermissionProfile(:REQUEST_ID, :AUTH_ID)';
begin
begin
