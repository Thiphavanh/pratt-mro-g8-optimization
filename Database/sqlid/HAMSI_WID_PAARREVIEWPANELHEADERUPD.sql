...
v_sql_id varchar2(85) :='HAMSI_WID_PAARREVIEWPANELHEADERUPD';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PAARReviewPanelHeaderUpd';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Update Sql for PAAR Review Tab Header Input UDV';
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfwid.application.IUtasOrderExt.updatePAARReviewHeader(:REQUEST_ID, :REQUEST_REASON, :REPLY_REQUIRED_DATE)';
begin
begin
