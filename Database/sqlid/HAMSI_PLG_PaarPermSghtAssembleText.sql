...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARPERMSGHTASSEMBLETEXT';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarPermSghtAssembleText';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='execquery com.utas.solumina.paar.application.AssembleText.permSghtAssembleText(:request_id, :@toolstate)';
