...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_PLG_PLANPARTINFODRAG.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_PLG_PLANPARTINFODRAG';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_PLG_PlanPartInfoDrag';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='SFPL';
v_description sfcore_sql_lib.description%type  :='Defect 936/933, defect 964/1034, defect 1136, defect 1272.';
...
FROM
(
SELECT PART_NO AS COMP_PART_NO,
