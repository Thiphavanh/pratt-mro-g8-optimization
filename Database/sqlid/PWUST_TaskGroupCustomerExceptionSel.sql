...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_TASKGROUPCUSTOMEREXCEPTIONSEL.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_TASKGROUPCUSTOMEREXCEPTIONSEL';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_TaskGroupCustomerExceptionSel';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='SFPL';
v_description sfcore_sql_lib.description%type  :='SMRO_PLG_205';
v_sql_text sfcore_sql_lib.sql_text%type  :='SELECT A.CUST_ID,
       A.CUST_ID_EXCEPTION,
       B.CUST_DESC,
       A.PLAN_ID,
       A.PLAN_UPDT_NO,
 ...
 WHERE CUST_ID_EXCEPTION = B.CUST_ID
