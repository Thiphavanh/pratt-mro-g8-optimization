...
v_sql_id varchar2(85) :='HAMSI_BOMSECURITYGROUPLOOKUP';
v_sql_id_displ varchar2(85) :='HAMSI_BomSecurityGroupLookup';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Clonned From MFI_BOMSECURITYGROUPLOOKUP';
...
WHERE
    ...
    AND SECURITY_GROUP NOT IN (SELECT SECURITY_GROUP
                            FROM SFPL_MFG_BOM_REV_SEC_GRP WHERE BOM_NO = :BOM_NO)
