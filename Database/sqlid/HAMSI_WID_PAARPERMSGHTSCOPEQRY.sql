...
v_sql_id varchar2(85) :='HAMSI_WID_PAARPERMSGHTSCOPEQRY';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarPermSghtScopeQry';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='select request_id,request_status from utasgi_wid_paar_desc where request_id = :request_id';
begin
begin
