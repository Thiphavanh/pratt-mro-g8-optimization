...
v_sql_id varchar2(85) :='HAMSI_FIREPAARREVIEW';
v_sql_id_displ varchar2(85) :='HAMSI_FirePAARReview';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfpl.application.IUtasPlan.firePaarReviewEvent(:REQUEST_ID)';
begin
begin
