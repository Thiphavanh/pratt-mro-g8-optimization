...
v_sql_id varchar2(85) :='HAMSI_WID_PAARPERMSGHTVALIDATEMODE';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarPermSghtValidateMode';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Permissions Sought Validate Mode Query';
v_sql_text varchar2(4000) :='execquery com.utas.solumina.paar.application.AssembleText.widPermSghtValidMode(:request_id, :@ValidToolModeType)';
begin
begin
