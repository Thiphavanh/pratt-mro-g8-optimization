...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARANYREQUESTEXISTSQRY';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarAnyRequestExistsQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Plan Requests - Any Request Exists';
v_sql_text varchar2(4000) :='select decode(count(*),0,''N'',''Y'') as any_request_exists from utasgi_plg_paar_desc where plan_id = :plan_id';
