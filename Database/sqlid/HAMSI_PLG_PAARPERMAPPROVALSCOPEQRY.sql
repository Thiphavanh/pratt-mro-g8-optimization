...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARPERMAPPROVALSCOPEQRY';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarPermApprovalScopeQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Permissions Approval Tool Scope Query';
v_sql_text varchar2(4000) :='select request_id,request_status from utasge_plg_paar_desc where request_id = :request_id';
begin
begin
