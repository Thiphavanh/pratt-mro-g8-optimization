...
set define off
prompt ---------------------------------------;
prompt Executing ... MFI_STDOPERSECURITYGROUPSEL.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='FOUNDATION';
v_sql_id sfcore_sql_lib.sql_id%type :='MFI_STDOPERSECURITYGROUPSEL';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='MFI_StdOperSecurityGroupSel';
