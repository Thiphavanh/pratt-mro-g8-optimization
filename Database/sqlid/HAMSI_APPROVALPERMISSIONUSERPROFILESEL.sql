...
set define off
prompt ---------------------------------------;
prompt Executing ... HAMSI_APPROVALPERMISSIONUSERPROFILESEL.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='FOUNDATION';
v_sql_id sfcore_sql_lib.sql_id%type :='HAMSI_APPROVALPERMISSIONUSERPROFILESEL';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='HAMSI_ApprovalPermissionUserProfileSel';
...
from utasge_plg_paar_pmn_auth a, sffnd_user_user_v b
