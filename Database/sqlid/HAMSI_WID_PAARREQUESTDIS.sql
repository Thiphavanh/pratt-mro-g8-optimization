...
v_sql_id varchar2(85) :='HAMSI_WID_PAARREQUESTDIS';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PAARRequestDis';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='WID PAAR Request Dispatch';
v_sql_text varchar2(4000) :='select request_id,
       ...
       last_action,
       security_group
  from utasgi_wid_paar_request_desc_v
