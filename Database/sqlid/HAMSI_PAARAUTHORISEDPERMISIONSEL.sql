...
v_sql_id varchar2(85) :='HAMSI_PAARAUTHORISEDPERMISIONSEL';
v_sql_id_displ varchar2(85) :='HAMSI_PAARAuthorisedPermisionSel';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Select PLG PAAR Authorised Permission Selection';
v_sql_text varchar2(4000) :='select a.request_id,
       ...
       a.last_action,
       '''' as security_group
  from utasgi_plg_paar_pmn_sght b,
       utasgi_plg_paar_pmn_auth a
