...
v_sql_id varchar2(85) :='HAMSI_PAARREVIEWPANELHEADERUPD';
v_sql_id_displ varchar2(85) :='HAMSI_PAARReviewPanelHeaderUpd';
v_read_only number :='';
...
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfpl.application.IUtasPlan.updatePAARReviewHeader(:REQUEST_ID, :REQUEST_REASON, :REPLY_REQUIRED_DATE)';
begin
begin
