...
set define off
prompt ---------------------------------------;
prompt Executing ... PWMROI_SFOR_SFPLPLANSUBJECTINS.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWMROI_721CCDAC8C2341B8A268719CCA67FBCE';
v_sql_id sfcore_sql_lib.sql_id%type :='PWMROI_SFOR_SFPLPLANSUBJECTINS';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWMROI_SFOR_SfplPlanSubjectIns';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='';
v_description sfcore_sql_lib.description%type  :='SFOR';
v_sql_text sfcore_sql_lib.sql_text%type  :='EXEC com.ibaset.solumina.sfor.application.ISfplPlan.insertSubjectTaskGroup (:PLAN_ID,:PLAN_VERSION,:PLAN_REVISION,:PLAN_ALTERATIONS ,:NEW_SUBJECT_NO,:TITLE,
:IS_DEFAULT,
