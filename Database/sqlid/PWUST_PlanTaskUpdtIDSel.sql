...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_PLANTASKUPDTIDSEL.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_PLANTASKUPDTIDSEL';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_PlanTaskUpdtIDSel';
...
TRIM(SUBSTR(C.UCF_PLAN_VCH4000_1,INSTR(C.UCF_PLAN_VCH4000_1, '':'', 1, 3)+1)) AS UCF_PLAN_VCH4000_1, 
C.UCF_PLAN_VCH255_1 AS NOTIFICATION_MATRIX
