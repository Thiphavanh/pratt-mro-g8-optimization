...
v_sql_id varchar2(85) :='HAMSI_WID_PAAROPENREQUESTEXISTSQRY';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarOpenRequestExistsQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Requests - Open Request Exists';
v_sql_text varchar2(4000) :='select decode(count(*),0,''N'',''Y'') as open_request_exists
  from utasgi_wid_paar_desc
