...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARPERMAPPROVALASSEMBLETEXT';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarPermApprovalAssembleText';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Permissions Approval Assemble Text Query';
v_sql_text varchar2(4000) :='execquery com.utas.solumina.paar.application.AssembleText.permApprovalAssembleText(:request_id, :@toolstate)';
begin
begin
