...
v_sql_id varchar2(85) :='HAMSI_PAARREQUESTINS';
v_sql_id_displ varchar2(85) :='HAMSI_PAARRequestIns';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Request Insert';
v_sql_text varchar2(4000) :='exec com.utas.solumina.sfpl.application.IUtasPlan.requestPaarReview(:plan_id, :plan_version, :plan_revision, :plan_alterations, :plan_updt_no, ''BUTTON'')';
begin
begin
