...
v_sql_id varchar2(85) :='HAMSI_PLG_PAARISPLANRESTRICTEDQRY';
v_sql_id_displ varchar2(85) :='HAMSI_PLG_PaarIsPlanRestrictedQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Requests - Is plan restricted';
v_sql_text varchar2(4000) :='select upper(a.ucf_plan_flag4) as ucf_plan_flag4,
       a.security_group
  from sfpl_plan_v a
