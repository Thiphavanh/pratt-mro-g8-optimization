...
v_sql_id varchar2(85) :='HAMSI_ORDERSECGRPAPPROVALPERMISSIONLOCATIONPROFILESEL';
v_sql_id_displ varchar2(85) :='HAMSI_OrderSecGrpApprovalPermissionLocationProfileSel';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Select Location Profile in Order Sec Group Approval Permission Location Grid';
v_sql_text varchar2(4000) :='select a.sght_id,
       ...
       a.time_stamp, 
       a.last_action
  from utasge_wid_paar_pmn_auth a, sffnd_work_loc_def b
 where a.request_id = :request_id
   and a.pmn_type = ''LOCATION''
   and a.pmn_action ! = ''DELETED''
   and a.pmn_type_entity = work_loc
