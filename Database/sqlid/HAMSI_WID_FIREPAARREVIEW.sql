...
v_sql_id varchar2(85) :='HAMSI_WID_FIREPAARREVIEW';
v_sql_id_displ varchar2(85) :='HAMSI_WID_FirePAARReview';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Fire PAAR Review Event';
v_sql_text varchar2(4000) :='EXEC com.utas.solumina.sfwid.application.IUtasOrder.sendPaarWORequest(:REQUEST_ID)';
begin
begin
