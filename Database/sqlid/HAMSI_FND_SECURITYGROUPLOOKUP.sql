...
v_sql_id varchar2(85) :='HAMSI_FND_SECURITYGROUPLOOKUP';
v_sql_id_displ varchar2(85) :='HAMSI_FND_SecurityGroupLookup';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Clonned From MFI_FND_SecurityGroupLookup';
v_sql_text varchar2(4000) :='SELECT
    SECURITY_GROUP AS SEC_GRP, SECURITY_GROUP_DESC
FROM
