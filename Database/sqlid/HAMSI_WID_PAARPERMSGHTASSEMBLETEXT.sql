...
v_sql_id varchar2(85) :='HAMSI_WID_PAARPERMSGHTASSEMBLETEXT';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarPermSghtAssembleText';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Permissions Sought Assemble Text Query';
v_sql_text varchar2(4000) :='execquery com.utas.solumina.paar.application.AssembleText.widPermSghtAssembleText(:request_id, :@toolstate)';
begin
begin
