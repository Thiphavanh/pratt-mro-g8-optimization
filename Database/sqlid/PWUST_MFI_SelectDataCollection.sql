...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_MFI_SELECTDATACOLLECTION.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_MFI_SELECTDATACOLLECTION';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_MFI_SelectDataCollection';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='SFPL';
v_description sfcore_sql_lib.description%type  :='Select Data Collection; SMRO_PLG_313';
v_sql_text sfcore_sql_lib.sql_text%type  :='SELECT
DAT_COL_TYPE
,null AS DAT_COL_TITLE
,A.UOM AS DAT_COL_UOM
,NULL AS UCF_STEP_DC_FLAG1
,NULL AS UCF_STEP_DC_VCH255_1
,SPC_FLAG
