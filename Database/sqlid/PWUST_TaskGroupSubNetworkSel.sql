...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_TASKGROUPSUBNETWORKSEL.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_TASKGROUPSUBNETWORKSEL';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_TaskGroupSubNetworkSel';
...
v_sql_text sfcore_sql_lib.sql_text%type  :='SELECT DISTINCT 
 ...
 WHERE A.ENGINE_TYPE = B.ENGINE_TYPE
   ...
   AND A.SUB_NETWORK_ACT = B.SUB_NETWORK_ACT
