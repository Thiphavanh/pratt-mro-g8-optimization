...
v_sql_id varchar2(85) :='HAMSI_PAARREQUESTDISPATCHSTATUSSEL';
v_sql_id_displ varchar2(85) :='HAMSI_PAARRequestDispatchStatusSel';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Request Dispatch Status Select';
v_sql_text varchar2(4000) :='SELECT REQUEST_STATUS FROM UTASGI_PLG_PAAR_DESC WHERE REQUEST_ID = :REQUEST_ID';
begin
begin
