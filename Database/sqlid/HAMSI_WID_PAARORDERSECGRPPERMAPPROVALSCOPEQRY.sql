...
v_sql_id varchar2(85) :='HAMSI_WID_PAARORDERSECGRPPERMAPPROVALSCOPEQRY';
v_sql_id_displ varchar2(85) :='HAMSI_WID_PaarOrderSecGrpPermApprovalScopeQry';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='PAAR Order Sec Grp Permissions Approval Tool Scope Query';
v_sql_text varchar2(4000) :='SELECT REQUEST_ID,REQUEST_STATUS FROM UTASGE_WID_PAAR_DESC WHERE REQUEST_ID = :REQUEST_ID';
begin
begin
