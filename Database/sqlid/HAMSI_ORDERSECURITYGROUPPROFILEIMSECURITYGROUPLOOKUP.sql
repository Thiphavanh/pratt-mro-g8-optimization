...
v_sql_id varchar2(85) :='HAMSI_ORDERSECURITYGROUPPROFILEIMSECURITYGROUPLOOKUP';
v_sql_id_displ varchar2(85) :='HAMSI_OrderSecurityGroupProfileIMSecurityGroupLookup';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFWID';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Order Security Group Lookup in Security Group Profile Input Matrix';
