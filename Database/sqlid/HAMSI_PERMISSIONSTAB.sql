...
v_sql_id varchar2(85) :='HAMSI_PERMISSIONSTAB';
v_sql_id_displ varchar2(85) :='HAMSI_PermissionsTab';
v_read_only number :='';
v_datasource varchar2(32) :='';
v_stype varchar2(32) :='SFPL';
v_site varchar2(10) :='HAMSI';
v_description varchar2(200) :='Permissions Tab';
v_sql_text varchar2(4000) :='SELECT A.REQUEST_ID,
       ...
       A.TIME_STAMP,
       A.LAST_ACTION
  FROM UTASGE_PLG_PAAR_PMN_AUTH A
