...
set define off
prompt ---------------------------------------;
prompt Executing ... PWUST_PLG_LATEST_FILEANDILLUSTRATIONORDERDISPLAY.sql
prompt ---------------------------------------;
declare
v_folder_id sfcore_sql_lib_folder.folder_id%type  :='PWUST_550FF0D87F6141A0E05387971F0AD3EA';
v_sql_id sfcore_sql_lib.sql_id%type :='PWUST_PLG_LATEST_FILEANDILLUSTRATIONORDERDISPLAY';
v_sql_id_displ sfcore_sql_lib.sql_id_displ%type  :='PWUST_PLG_Latest_FileAndIllustrationOrderDisplay';
v_read_only sfcore_sql_lib.read_only%type  :='';
v_datasource sfcore_sql_lib.datasource%type  :='';
v_stype sfcore_sql_lib.stype%type  :='';
v_description sfcore_sql_lib.description%type  :='Display Latest File and Illustration  Order DEFECT 1906';
...
FROM
  (
    ...
    A.OBJECT_ID as OBJECT_ID,
     ...
     FROM SFFND_OBJECT_CLASSIFICATION A,SFCORE_MM_OBJECT C,SFCORE_MM_OBJECT_SEC_GRP XX,SFWID_ORDER_DESC_SEC_GRP YY,SFFND_USER_SEC_GRP ZZ,
