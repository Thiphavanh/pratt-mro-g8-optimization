-- Create table
create table UTASGE_PLG_PAAR_DESC
(
...
create index UTASGE_PLG_PAAR_DESC_IX1 on UTASGE_PLG_PAAR_DESC (PLAN_NO, PLAN_VERSION, PLAN_REVISION, PLAN_ALTERATIONS)
...
alter table UTASGE_PLG_PAAR_DESC
  add constraint UTASGE_PLG_PAAR_DESC_PK primary key (REQUEST_ID)
  using index 
  tablespace SFPL_INDEXES
  pctfree 10
  initrans 2
...
/
alter index UTASGE_PLG_PAAR_DESC_PK nologging;
/