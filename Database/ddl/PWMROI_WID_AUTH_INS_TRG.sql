create or replace trigger pwmroi_wid_auth_ins_trg after  insert on sfwid_order_desc
FOR EACH ROW
DECLARE
   ...
   for a in (select subject_no, subject_rev,subject_descrIption,authority_type,authority_detail,
    ...
    SEQNO) --defect 1890
     ...
     (SELECT :new.order_id,a.subject_no,a.subject_rev,a.subject_description,a.authority_type,
              ...
              a.authority_type||a.manual_section||a.authority_detail,PWMROI_PLAN_SUBJ_AUTH_SEQ.nextval FROM DUAL);
  END LOOP;
END;
/