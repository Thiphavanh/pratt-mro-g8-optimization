...
-- Created by X006640 on 7/23/2020, 4:53:11 PM --
-------------------------------------------------
...
FROM SFWID_ORDER_DESC T, PWUST_SFWID_ORDER_DESC T2
 WHERE T.ORDER_ID = T2.ORDER_ID
   AND T.ITEM_SUBTYPE <> 'OVERHAUL'--Defect 1739
   AND ((upper(T.ORDER_TYPE) IN ('REPAIR', 'MATERIAL','SUPPLEMENTAL', 'SUB ORDER', 'REWORK')));
